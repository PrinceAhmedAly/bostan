      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center p-1">
          ...
          <div>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-blue-300 transition">عن الموقع</a></li>
              <li><a href="#" className="hover:text-blue-300 transition"> </a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-around items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} مبادرة التوعية الجنسية الآمنة. جميع الحقوق محفوظة.
          </div>
          <div className="text-gray-400 text-sm flex items-center">
            <span>تصميم وتطوير</span>
            <a href="#" className="text-blue-300 hover:text-blue-400 mx-1"> Dreamer</a>
            <span>بكل</span>
